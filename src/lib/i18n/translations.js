export const t = {
  es: {
    ...
    hola: "Hola, soy",
    descripcion:
      "Desarrollo full stack con React y NestJS. Me gusta construir productos completos, del frontend al servidor. Busco un equipo donde pueda aportar desde el día uno.",
  ...
  en: {
    ...
    hola: "Hi, I'm",
    descripcion:
      "Full stack development with React and NestJS. I enjoy building complete products, from frontend to server. Looking for a team where I can contribute from day one.",
